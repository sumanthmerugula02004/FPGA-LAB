...
int main(void)
{
    ...
    // inputs
    PyHal_GPIO_SetDir(1,0);  // u
    PyHal_GPIO_SetDir(5,0); // v
    PyHal_GPIO_SetDir(9,0); // w
    PyHal_GPIO_SetDir(13,0); // z
    
    //outputs
    PyHal_GPIO_SetDir(22,1); // redled
    PyHal_GPIO_SetDir(21,1); // greenled
    PyHal_GPIO_SetDir(18,1); // blueled
    int u,v,w,z,g;
